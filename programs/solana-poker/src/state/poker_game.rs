...
pub struct PokerGame {
    ...
    /// Random value used for shuffling positions
    /// Handle bytes (shuffle_random.0) used for Fisher-Yates shuffle
    pub shuffle_random: Euint128,
    /// Bounded random offset (shuffle_random % 52) applied to all cards
...
impl PokerGame {
    ...
    /// + 16 (shuffle_random) + 16 (card_offset) + 5 (shuffled_indices) + 160 (deal_cards) + 80 (community_cards)
